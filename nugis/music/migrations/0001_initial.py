...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.Gender')),
                ('track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='music.Track')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='track',
            name='genders',
            field=models.ManyToManyField(related_name='tracks', through='music.TrackGender', to='music.Gender'),
        ),
        migrations.AddField(
